...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/satria-client-datawarehouse",
    "generated/satria-client-datawarehouse",
  ]
...
path.join(process.cwd(), "prisma/generated/satria-client-datawarehouse/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/satria-client-datawarehouse/schema.prisma")
